...
log.rel.sens_race <- log(sapply(table_2, `[[`, c("result", "y1y3", "sensitivity", "rel.sens")))[levels(septa$race)]
se.log.rel.sens_race  <- sapply(table_2, `[[`, c("result", "y1y3", "sensitivity", "se.log.rel.sens"))[levels(septa$race)]
chi2.rel.sens_race <- aod::wald.test(Sigma = diag(se.log.rel.sens_race^2), 
                                     b = log.rel.sens_race, 
                                     L = contrast_matrix)

log.rel.spec_race <- log(sapply(table_2, `[[`, c("result", "y1y3", "specificity", "rel.spec")))[levels(septa$race)]
se.log.rel.spec_race  <- sapply(table_2, `[[`, c("result", "y1y3", "specificity", "se.log.rel.spec"))[levels(septa$race)]
