...
#| fig-width: 6
#| fig-height: 6
ggplot(septa, aes(x = 0.5*(log10(psa)+log10(psa_a3p)), y = log10(psa)-log10(psa_a3p))) +
  ...
  theme_minimal(base_size = 12) +
  labs(x = "A = log10(PSA * PSA for Stockholm3)/2",
       y = "M = log10(PSA / PSA for Stockholm3)",
...
plot with axes in the log-scale.)
