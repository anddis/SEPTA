...
```{r}
cancers_missed_detected <- septa_calibration |> 
...
cancers_missed_detected[[1]]

cancers_missed_detected[[2]]

cancers_missed_detected[[3]]

cancers_missed_detected[[4]]

cancers_missed_detected[[5]]
```
...
septa_alternative_gg <- septa |> 
  make_alternative_grade_group()
```

Cross-classification Combined biopsy GG versus Alternative outcome definition
